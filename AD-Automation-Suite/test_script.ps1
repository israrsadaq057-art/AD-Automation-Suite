...
# ============================================================
Write-Host "`n[1] Checking Active Directory Module..." -ForegroundColor Yellow
...
# ============================================================
Write-Host "`n[2] Attempting to connect to AD Domain..." -ForegroundColor Yellow
...
# ============================================================
# STEP 3: Basic AD Query Structure (What you'd use in production)
# ============================================================
Write-Host "`n[3] AD Query Syntax (for reference)" -ForegroundColor Yellow

Write-Host @"
In a real AD environment, you'd use commands like:
...
# Get specific user
Get-ADUser -Identity "israr.sadaq"

# Get group members
Get-ADGroupMember -Identity "IT_Admins"

# Create a new user
New-ADUser -Name "John Doe" -SamAccountName "jdoe" -Department "IT"
...
# ============================================================
Write-Host "`n[4] Simulated AD Query (Learning without real AD)" -ForegroundColor Yellow
...
Write-Host "`n[OK] Connection test completed!" -ForegroundColor Green